...
export function CategoryPills({
  ...
  return (
    <div className="relative">
        ...
        {categories.map((cat) => {
          ...
          return (
            <button
              ...
              className={`shrink-0 md:shrink px-3 py-1.5 rounded-full text-sm font-medium transition-colors ${
                isSelected
      ...
      <div className="absolute right-0 top-0 bottom-2 w-8 bg-gradient-to-l from-[#1a1a2e] to-transparent pointer-events-none md:hidden" />
    </div>
  );
}
