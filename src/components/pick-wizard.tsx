    ...
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-4xl px-4 py-8">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="mt-1 text-sm text-yellow-800">
                  You have {minutesUntilLock} minute{minutesUntilLock !== 1 ? "s" : ""} to complete
                  your picks. You have {categories.length - completedCategoryIds.size} categor
        ...
        <div className="mt-8 text-center">
          <a href="/dashboard" className="text-sm text-indigo-600 hover:text-indigo-700 underline">
            Back to My Games
          </a>
        </div>
      </div>
